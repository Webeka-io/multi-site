    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        <div className="space-y-8">
          ...
          <div className="overflow-hidden">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-display font-black bg-gradient-to-r from-red-500 to-red-700 bg-clip-text text-transparent leading-none tracking-tighter animate-slide-up-delay">
              CUT
            </h1>
          </div>
          <div className="overflow-hidden">
            <p className="text-xl md:text-2xl text-gray-300 font-serif italic max-w-2xl mx-auto animate-fade-in-delay">
              "Votre Barbier de Quartier, Redéfini"
            </p>
          </div>
          <div className="overflow-hidden">
            <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto animate-fade-in-delay-2">
              L'art traditionnel du barbier rencontre l'élégance moderne. Coupes précises, barbes sculptées, style
              intemporel.
            </p>
          </div>
