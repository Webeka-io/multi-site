...
import { Card, CardContent, CardHeader, CardTitle } from "@/app/secteur/barber/[slug]/model2/components/ui/card"
import { Button } from "@/app/secteur/barber/[slug]/model2/components/ui/button"
import { Input } from "@/app/secteur/barber/[slug]/model2/components/ui/input"
import { Label } from "@/app/secteur/barber/[slug]/model2/components/ui/label"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/app/secteur/barber/[slug]/model2/components/ui/select"
import { Calendar } from "@/app/secteur/barber/[slug]/model2/components/ui/calendar"
import { Textarea } from "@/app/secteur/barber/[slug]/model2/components/ui/textarea"
          ...
          <CardContent className="p-8">
            {isBooked ? (
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="lg:col-span-2 pt-8 mx-auto">
                  <Button
                    type="submit"
                    size="lg"
                    className="  bg-amber-600 hover:bg-amber-700 text-white font-medium text-lg py-4 rounded-full"
                  >
                   Rendez-vous
                  </Button>
                </div>
